...
<head>
    ...
    <title>WebTadka - Terms & Conditions</title>
    <link rel="icon" type="image/x-icon" href="assets/favicon.ico" />
    <!-- Core theme CSS (includes Bootstrap)-->
    <link href="{{ asset('assets/css/privecy_policy/styles.css') }}" rel="stylesheet" />
</head>

<body id="page-top">

    <!-- Header-->
    <header class="bg-gradient text-white" style="background-color: #0ea2bd">
        <div class="container px-4 text-center">
            ...
            <p class="lead">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                been the industry's standard dummy text ever since the 1500ss</p>
        </div>
    </header>
    <!-- About section-->
    <section id="about">
