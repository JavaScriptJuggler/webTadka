@extends('frontend.pages.blogs.layout', ['title' => 'Blogs'])
    ...
    <div class="row gy-4 posts-list">
        ...
        <div class="col-lg-6">
            <article class="d-flex flex-column">
                ...
                <h2 class="title">
                    <a href="{{route('blog-details',777)}}">Dolorum optio tempore voluptas dignissimos cumque fuga qui
                        quibusdam quia</a>
                </h2>

                <div class="meta-top">
                    <ul>
                        <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="{{route('blog-details',777)}}">John
                                Doe</a></li>
                        <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="{{route('blog-details',777)}}"><time
                                    datetime="2022-01-01">Jan 1, 2022</time></a>
                        </li>
                        <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="{{route('blog-details',777)}}">12
                                Comments</a></li>
                    </ul>
                </div>
        ...
        <div class="col-lg-6">
            <article class="d-flex flex-column">
                ...
                <h2 class="title">
                    <a href="{{route('blog-details',777)}}">Nisi magni odit consequatur autem nulla dolorem</a>
                </h2>
        ...
        <div class="col-lg-6">
            <article class="d-flex flex-column">
                ...
                <h2 class="title">
                    <a href="{{route('blog-details',777)}}">Possimus soluta ut id suscipit ea ut. In quo quia et soluta
                        libero sit sint.</a>
                </h2>
        ...
        <div class="col-lg-6">
            <article class="d-flex flex-column">
                ...
                <h2 class="title">
                    <a href="{{route('blog-details',777)}}">Non rem rerum nam cum quo minus. Dolor distinctio deleniti
        ...
        <div class="col-lg-6">
            <article class="d-flex flex-column">
                ...
                <h2 class="title">
                    <a href="{{route('blog-details',777)}}">Accusamus quaerat aliquam qui debitis facilis
                        consequatur</a>
                </h2>
                ...
                <div class="meta-top">
                    <ul>
                        ...
                        <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a
                                href="{{route('blog-details',777)}}"><time datetime="2022-01-01">Jan 1,
                                    2022</time></a></li>
                        <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a
                                href="{{route('blog-details',777)}}">12 Comments</a></li>
                    </ul>
                </div>
        ...
        <div class="col-lg-6">
            <article class="d-flex flex-column">
                ...
                <h2 class="title">
                    <a href="{{route('blog-details',777)}}">Distinctio provident quibusdam numquam aperiam aut</a>
                </h2>

                <div class="meta-top">
                    <ul>
                        <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a
                                href="{{route('blog-details',777)}}">John Doe</a></li>
                        <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a
                                href="{{route('blog-details',777)}}"><time datetime="2022-01-01">Jan 1,
                                    2022</time></a></li>
                        <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a
