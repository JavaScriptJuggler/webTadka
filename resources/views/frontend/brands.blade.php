<section id="brands" class="features">
    <div class="container" data-aos="fade-up">
        <div class="section-header">
            <h2>Brands That Trust WebTadka</h2>
            ...
            @for ($i = 0; $i < 12; $i++)
                <div class="col-md-2 col-sm-6 col-6 mb-2 text-center">
                    <img style="object-fit: fit;" height="100px" width="200px"
                        src="https://www.thebrandingjournal.com/wp-content/uploads/2016/06/branding_importance_the_branding_journal_1.jpg"
